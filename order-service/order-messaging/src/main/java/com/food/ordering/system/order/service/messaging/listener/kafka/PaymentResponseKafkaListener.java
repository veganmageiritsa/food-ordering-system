...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public PaymentResponseKafkaListener(
        final PaymentResponseMessageListener paymentResponseMessageListener,
    ...
    public void receive(
        ...
        log.info("{} number o f payment response received with keys: {}, partitions : {}, offsets : {}",
                 messages.size(),
                 keys.toString(),
                 partitions.toString(),
                 offsets.toString());
        ...
        messages
            .forEach(paymentResponseAvroModel -> {
                try {
