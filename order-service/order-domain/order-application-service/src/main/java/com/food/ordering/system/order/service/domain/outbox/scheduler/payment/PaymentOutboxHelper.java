...
public class PaymentOutboxHelper {
    ...
    public PaymentOutboxHelper(final PaymentOutboxRepository paymentOutboxRepository, final ObjectMapper objectMapper) {
        this.paymentOutboxRepository = paymentOutboxRepository;
        this.objectMapper = objectMapper;
    }
    
    @Transactional(readOnly = true)
    public Optional<List<OrderPaymentOutboxMessage>> getOrderPaymentOutboxMessageByOutboxStatusAndSagaStatus(
    ...
    @Transactional(readOnly = true)
    public Optional<OrderPaymentOutboxMessage> getOrderPaymentOutboxMessageBySagaIdAndSagaStatus(
        UUID sagaId,
        SagaStatus... sagaStatus) {
